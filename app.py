...
def CovidCases():
    ...
    fig = go.Figure()
    st.write("""# Covid-19 Analysis App""")
    st.write('Covid-19 came with a seriously shocking series of ripple events. It took the world unaware if we are being honest. Hundreds of thousands of people across nations of the world have been affected greatly by it. ')
    st.write('So, this app was built to see how well different countries are fairing and the trend in the last 6 months!')


    ("""[COVID-19 API](https://documenter.getpostman.com/view/10808728/SzS8rjbc?version=latest#81447902-b68a-4e79-9df9-1b371905e9fa) is used to get the data in this app.""")
